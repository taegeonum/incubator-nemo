 ...
 */
public final class GBKCombineFinalTransform<K, InputT>
  ...
  private static final Logger LOG = LoggerFactory.getLogger(GBKCombineFinalTransform.class.getName());
   ...
   */
  public GBKCombineFinalTransform(final Coder inputcoder,
...
//      inMemoryStateInternalsFactory.getNumKeys(), getContext().getTaskId());
   ...
   * The collected data are emitted at {@link GBKCombineFinalTransform#onWatermark(Watermark)}
...
//    }
  ...
  final class GBKWOutputCollector extends AbstractOutputCollector<WindowedValue<KV<K, Iterable<InputT>>>> {
    private final OutputCollector<WindowedValue<KV<K, Object>>> outputCollector;
    GBKWOutputCollector(final OutputCollector<WindowedValue<KV<K, Object>>> outputCollector) {
