...
public final class SimpleMapITCase {
  ...
  public void setUp() throws Exception {
    builder = new ArgBuilder()
        .addUserMain(SimpleMap.class.getCanonicalName())
  ...
  public void test() throws Exception {
    JobLauncher.main(builder
        ...
        .addJobId(SimpleMapITCase.class.getSimpleName())
  ...
  public void testLargeShuffle() throws Exception {
    JobLauncher.main(builder
        .addResourceJson(executorResourceFileName)
        .addJobId(SimpleMapITCase.class.getSimpleName() + "_largeShuffle")
  ...
  public void testLargeShuffleInOneExecutor() throws Exception {
    JobLauncher.main(builder
        ...
        .addJobId(SimpleMapITCase.class.getSimpleName() + "_largeshuffleInOneExecutor")
        .addOptimizationPolicy(LargeShufflePolicyParallelismFive.class.getCanonicalName())
        .build());
  }
  ...
  public void testConditionalLargeShuffle() throws Exception {
    JobLauncher.main(builder
        .addResourceJson(executorResourceFileName)
        .addJobId(SimpleMapITCase.class.getSimpleName() + "_conditionalLargeShuffle")
  ...
  public void testTransientResource() throws Exception {
    JobLauncher.main(builder
        .addResourceJson(executorResourceFileName)
        .addJobId(SimpleMapITCase.class.getSimpleName() + "_transient")
  ...
  public void testClonedScheduling() throws Exception {
    JobLauncher.main(builder
        .addResourceJson(executorResourceFileName)
        .addJobId(SimpleMapITCase.class.getSimpleName() + "_clonedscheduling")
  ...
  public void testSpeculativeExecution() throws Exception {
    JobLauncher.main(builder
      .addResourceJson(executorResourceFileName)
      .addJobId(SimpleMapITCase.class.getSimpleName() + "_speculative")
      .addMaxTaskAttempt(Integer.MAX_VALUE)
