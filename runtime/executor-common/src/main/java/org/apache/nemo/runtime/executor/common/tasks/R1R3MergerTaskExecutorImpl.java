...
import org.apache.nemo.runtime.executor.common.watermarks.R2MultiPairWatermarkManager;
import org.apache.nemo.runtime.executor.common.watermarks.R2SinglePairWatermarkManager;
import org.apache.nemo.runtime.executor.common.watermarks.R2WatermarkManager;
...
public final class R1R3MergerTaskExecutorImpl implements MergerTaskExecutor {
   ...
   */
  public R1R3MergerTaskExecutorImpl(final long threadId,
  ...
  public void setRerouting(final String originTask,
    ...
    throw new RuntimeException("Not supported for R1R3 merger rerouting " + taskId);
  }
