...
//
//  @Override
//  public void receiveStopSignalFromChild(final TaskLoc dt, String tid) {
//    LOG.info("LocalByteOutputContext receiveStopSignalFromChild: {}", getContextId().getTransferIndex());
//    sendDataTo = dt;
//    isPending = true;
//  }
//
...
//      if (isPending) {
//        // buffer data..
//        // because currently the data processing is receiveStopSignalFromChild
//        switch (sendDataTo) {
//          case SF:
...
//        }
//      } else {
//        // if there are receiveStopSignalFromChild data,
//        if (!pendingData.isEmpty()) {
